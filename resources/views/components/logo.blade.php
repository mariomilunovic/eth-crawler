<div id="logo" class="card flex-row justify-center py-2 pr-4 items-center bg-orange-400 text-white font-bold">

    <svg class="h-8 w-10" viewBox="-80.5 0 417 417" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
        <g>
    ...
    <h1 class="whitespace-nowrap text-xl font-semibold text-white text-shadow-md">ETH Crawler</h1>
